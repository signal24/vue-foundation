<template>
    <div data-testid="demo-confirm-destroy">
        <button @click="handleConfirmDestroy">Show Confirm Destroy</button>
...
import { ref } from 'vue';
import { showConfirmDestroy } from '@zyno-io/vue-foundation';
