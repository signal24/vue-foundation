<template>
    <div data-testid="demo-ss-grouped" style="max-width: 320px">
        <VfSmartSelect
            v-model="value"
            :options="options"
            :label-field="'label'"
...
const options = [
    ...
    { value: '4', label: 'Carrot', group: 'Vegetables' },
    { value: '5', label: 'Broccoli', group: 'Vegetables' },
    { value: '6', label: 'Spinach', group: 'Vegetables' }
];
